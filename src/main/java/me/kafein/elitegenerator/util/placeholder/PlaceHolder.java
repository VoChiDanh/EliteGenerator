...
public class PlaceHolder {
    ...
    public static String replace(final String text, final Generator generator) {
        return ChatColor.translateAlternateColorCodes('&', text
                ...
                .replace("%generator_location%", LocationSerializer.serialize(generator.getGeneratorLocation(), false))
                ...
                .replace("%generator_hologram_enabled%", (generator.isHologramEnabled() ? ENABLED : DISABLED))
                ...
                .replace("%generator_auto_chest_enabled%",
                        (generator.isAutoChestEnabled() ? LocationSerializer.serialize(generator.getAutoChest().getChestLocation(), false) : DISABLED)));
    }
